 ...
 */
PARTONS::DVCSConvolCoeffFunctionResult computeSingleKinematicsForDVCSComptonFormFactor(double xi, double t, double Q2, double muF2, double muR2);
...
PARTONS::TCSConvolCoeffFunctionResult computeSingleKinematicsForTCSComptonFormFactor(double xi, double t, double Q2Prim, double muF2, double muR2);
