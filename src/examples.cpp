...
PARTONS::DVCSConvolCoeffFunctionResult computeSingleKinematicsForDVCSComptonFormFactor(
    ...
    PARTONS::DVCSConvolCoeffFunctionKinematic cffKinematic =
            PARTONS::DVCSConvolCoeffFunctionKinematic(xi, t, Q2, muF2, muR2);
...
PARTONS::TCSConvolCoeffFunctionResult computeSingleKinematicsForTCSComptonFormFactor(
        double xi, double t, double Q2Prim, double muF2, double muR2) {

    // Retrieve service
    PARTONS::TCSConvolCoeffFunctionService* pTCSConvolCoeffFunctionService =
            PARTONS::Partons::getInstance()->getServiceObjectRegistry()->getTCSConvolCoeffFunctionService();
    ...
    // Create CFF module with the BaseModuleFactory
    PARTONS::TCSConvolCoeffFunctionModule* pTCSCFFModule =
    ...
    // Create kinematic
    PARTONS::TCSConvolCoeffFunctionKinematic cffKinematic =
            PARTONS::TCSConvolCoeffFunctionKinematic(xi, t, Q2Prim, muF2,
                    muR2);
    ...
    // Print results for TCSCFFModule
    /*PARTONS::Partons::getInstance()->getLoggerManager()->info("main", __func__,
     cffResult.toString());*/
